...
namespace QuantLibAddin {
    ...
    void registerEnumeratedTypes() {
...

        {
            ...
            create.registerType("QuantLib::BusinessDayConvention(QuantLib::ModifiedFollowing)", new QuantLib::BusinessDayConvention(QuantLib::ModifiedFollowing));
            create.registerType("QuantLib::BusinessDayConvention(QuantLib::Following)", new QuantLib::BusinessDayConvention(QuantLib::Following));
            create.registerType("QuantLib::BusinessDayConvention(QuantLib::Unadjusted)", new QuantLib::BusinessDayConvention(QuantLib::Unadjusted));
        }

        {
            ...
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::NullCalendar()", new QuantLib::NullCalendar());
        }
...

        {
            ...
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::Compounding(QuantLib::Compounded)", new QuantLib::Compounding(QuantLib::Compounded));
            create.registerType("QuantLib::Compounding(QuantLib::Continuous)", new QuantLib::Compounding(QuantLib::Continuous));
            create.registerType("QuantLib::Compounding(QuantLib::Simple)", new QuantLib::Compounding(QuantLib::Simple));
        }
...

        {
            ...
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::DateGeneration::Rule(QuantLib::DateGeneration::Backward)", new QuantLib::DateGeneration::Rule(QuantLib::DateGeneration::Backward));
        }

        {
            ...
            create.registerType("QuantLib::ActualActual(QuantLib::ActualActual::ISDA)", new QuantLib::ActualActual(QuantLib::ActualActual::ISDA));
            create.registerType("QuantLib::ActualActual(QuantLib::ActualActual::ISMA)", new QuantLib::ActualActual(QuantLib::ActualActual::ISMA));
        }

        {
            ...
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::Duration::Type(QuantLib::Duration::Modified)", new QuantLib::Duration::Type(QuantLib::Duration::Modified));
        }
...

        {
            ...
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::Frequency(QuantLib::Annual)", new QuantLib::Frequency(QuantLib::Annual));
        }
        ...
        {
            reposit::Create<QuantLib::MixedInterpolation::Behavior> create;
            create.registerType("ShareRanges", new QuantLib::MixedInterpolation::Behavior(QuantLib::MixedInterpolation::ShareRanges));
            create.registerType("SplitRanges", new QuantLib::MixedInterpolation::Behavior(QuantLib::MixedInterpolation::SplitRanges));
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::MixedInterpolation::Behavior(QuantLib::MixedInterpolation::ShareRanges)", new QuantLib::MixedInterpolation::Behavior(QuantLib::MixedInterpolation::ShareRanges));
        }
        ...
        {
            reposit::Create<QuantLib::VolatilityType> create;
            create.registerType("Normal", new QuantLib::VolatilityType(QuantLib::Normal));
            create.registerType("ShiftedLognormal", new QuantLib::VolatilityType(QuantLib::ShiftedLognormal));
            // FIXME autogenerated code retrieves enum default value by name, this temorary hack makes it work.
            create.registerType("QuantLib::VolatilityType(QuantLib::ShiftedLognormal)", new QuantLib::VolatilityType(QuantLib::ShiftedLognormal));
        }
...

        {
            ...
            create.registerType("LogMixedLinearCubicNaturalSpline", new QuantLibAddin::InterpolatedYieldCurve::Interpolator(QuantLibAddin::InterpolatedYieldCurve::LogMixedLinearCubicNaturalSpline));
            create.registerType("LogMixedLinearKrugerCubic", new QuantLibAddin::InterpolatedYieldCurve::Interpolator(QuantLibAddin::InterpolatedYieldCurve::LogMixedLinearKrugerCubic));
            create.registerType("LogMixedLinearMonotonicCubicNaturalSpline", new QuantLibAddin::InterpolatedYieldCurve::Interpolator(QuantLibAddin::InterpolatedYieldCurve::LogMixedLinearMonotonicCubicNaturalSpline));
            ...
            create.registerType("MixedLinearCubicNaturalSpline", new QuantLibAddin::InterpolatedYieldCurve::Interpolator(QuantLibAddin::InterpolatedYieldCurve::MixedLinearCubicNaturalSpline));
            create.registerType("MixedLinearKrugerCubic", new QuantLibAddin::InterpolatedYieldCurve::Interpolator(QuantLibAddin::InterpolatedYieldCurve::MixedLinearKrugerCubic));
            create.registerType("MixedLinearMonotonicCubicNaturalSpline", new QuantLibAddin::InterpolatedYieldCurve::Interpolator(QuantLibAddin::InterpolatedYieldCurve::MixedLinearMonotonicCubicNaturalSpline));
    ...
    void unregisterEnumeratedTypes() {
        ...
        reposit::Create<QuantLib::MixedInterpolation::Behavior>().unregisterTypes();
        ...
        reposit::Create<QuantLib::Pillar::Choice>().unregisterTypes();
        ...
        reposit::Create<QuantLib::VolatilityType>().unregisterTypes();
