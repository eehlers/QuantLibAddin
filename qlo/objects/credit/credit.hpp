...
namespace QuantLibAddin {
	...
	*/
    class Issuer
        : public reposit::LibraryObject<QuantLib::Issuer> {
    public:
        Issuer(
    ...
    class DefaultEventSet
        : public reposit::LibraryObject<QuantLib::DefaultEventSet> {
    public:
        DefaultEventSet(
            const boost::shared_ptr<reposit::ValueObject>& properties,
    ...
    class RecoveryRateQuote : public Quote {
      public:
        RecoveryRateQuote(const boost::shared_ptr<reposit::ValueObject>& properties,
                    QuantLib::Seniority sen,
                    QuantLib::Real value,
                    bool permanent);
    ...
    class DefaultProbabilityHelper 
        : public reposit::LibraryObject<QuantLib::DefaultProbabilityHelper> {
      protected:
        RP_LIB_CTOR(DefaultProbabilityHelper, QuantLib::DefaultProbabilityHelper);
    };
