...
#include <qlo/objects/obj_assetswap.hpp>
#include <ql/instruments/assetswap.hpp>
#include <ql/pricingengines/swap/discountingswapengine.hpp>

QuantLibAddin::AssetSwap::AssetSwap(
...
std::vector< std::vector< reposit::property_t > > QuantLibAddin::AssetSwap::bondLegAnalysis(
    QuantLib::Date const &AfterDate) {
    return Swap::legAnalysis(0, AfterDate);
}

//****MEMBER*****
std::vector< std::vector< reposit::property_t > > QuantLibAddin::AssetSwap::floatingLegAnalysis(
    QuantLib::Date const &AfterDate) {
    return Swap::legAnalysis(1, AfterDate);
}