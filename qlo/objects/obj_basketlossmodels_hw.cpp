...
QuantLibAddin::GaussianLHPLossModel::GaussianLHPLossModel(
...
QuantLibAddin::IHGaussPoolLossModel::IHGaussPoolLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
...
QuantLibAddin::IHStudentPoolLossModel::IHStudentPoolLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const QuantLib::Real correlation,
    const std::vector<QuantLib::Real>& recoveryRates,
...
QuantLibAddin::GaussianBinomialLossModel::GaussianBinomialLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
...
QuantLibAddin::TBinomialLossModel::TBinomialLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
...
QuantLibAddin::BaseCorrelationLossModel::BaseCorrelationLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
...
QuantLibAddin::GaussianRandomDefaultLM::GaussianRandomDefaultLM(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
...
QuantLibAddin::GaussianRandomLossLM::GaussianRandomLossLM(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
...
QuantLibAddin::TRandomDefaultLM::TRandomDefaultLM(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
    const std::vector<QuantLib::Real>& copulaInitVals,
...
QuantLibAddin::TRandomLossLM::TRandomLossLM(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
    const std::vector<QuantLib::Real>& copulaInitVals,
...
QuantLibAddin::SaddlePointLossModel::SaddlePointLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
    bool permanent
...
QuantLibAddin::TSaddlePointLossModel::TSaddlePointLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
    const std::vector<QuantLib::Real>& copulaInitVals,
...
QuantLibAddin::RecursiveGaussLossModel::RecursiveGaussLossModel(
    const boost::shared_ptr<reposit::ValueObject>& properties,
    const std::vector<std::vector<QuantLib::Real> >& factorWeights,
    const std::vector<QuantLib::Real>& recoveryRates,
    bool permanent
