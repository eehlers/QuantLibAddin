//
//#ifndef obj_interpolation_hpp
//#define obj_interpolation_hpp
//
//#include <string>
...
//    OH_OBJ_CLASS(Interpolation, Extrapolator);
...
//            std::vector< QuantLib::Real > const &x,
//            std::vector< QuantLib::Handle< QuantLib::Quote > > const &y,
//            // END   typemap rp_tm_default
//            bool permanent)
//        : Interpolation(properties, permanent) {
//            libraryObject_ = boost::shared_ptr<QuantLibAddin::Interpolation>(new QuantLibAddin::GenericInterp(
//                // BEGIN typemap rp_tm_default
//                type,
//                x,
//                y
    ...
    class Interpolation : public Extrapolator, public QuantLib::LazyObject {
      public:
        ...
        QuantLib::Real interpolate(QuantLib::Real x,
                                  bool allowExtrapolation) const {
            return this->operator()(x, allowExtrapolation);
        }
