...
%typemap(rp_cpp_cnv) boost::shared_ptr<QuantLib::StrikedTypePayoff> const & %{
    boost::shared_ptr<QuantLib::StrikedTypePayoff> $1_name_enum =
        ObjectHandler::Create<boost::shared_ptr<QuantLib::StrikedTypePayoff> >()($1_name);
%}
...
%typemap(rp_cpp_call) boost::shared_ptr<QuantLib::StrikedTypePayoff> const & "$1_name_enum";
...
%typemap(rp_excel_in) boost::shared_ptr< QuantLib::Exercise > const & "X";
