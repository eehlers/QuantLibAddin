    ...
    class Bond : public Instrument {
      public:
        ...
        Bond(
            ...
            const QuantLib::Currency& Currency/*=NullCurrency*/,                            //!< bond Currency.
            QuantLib::Natural SettlementDays/*=3*/,                                         //!< settlement days.
            const QuantLib::Calendar& Calendar/*=NullCalendar*/,                            //!< holiday calendar (e.g. TARGET).
            QuantLib::Real FaceAmount/*=100.0*/,                                            //!< Face nominal amount.
            const QuantLib::Date& MaturityDate/*=QuantLib::Date()*/,                        //!< maturity date.
    ...
    class FloatingRateBond : public Bond {
      public:
        ...
        FloatingRateBond(
            ...
            const std::vector<QuantLib::Spread>& Spreads=0.0,                               //!< floating rate spreads.
    ...
    class CmsRateBond : public Bond {
      public:
        ...
        CmsRateBond(
            ...
            const std::vector<QuantLib::Rate>& Floors/*=std::vector<QuantLib::Rate>()*/,    //!< floor strikes.
            const std::vector<QuantLib::Real>& Gearings=1.0,                                //!< floating rate gearings.
            const boost::shared_ptr<QuantLib::SwapIndex>& SwapIndex,                        //!< floating rate index.
