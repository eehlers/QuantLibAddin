...
%typemap(rp_add_typ) ql_val_dbl "double";

%typemap(rp_add_in) ql_val_dbl "double";
%typemap(rp_add_in) ql_val_str "const std::string&";
%typemap(rp_add_in) ql_val_any "const ObjectHandler::property_t&";
...
%typemap(rp_add_call) ql_cnv_val "$1_name_cnv";
%typemap(rp_add_call) ql_cnv_enm "$1_name_enum";
%typemap(rp_add_call) ql_cnv_hnd "$1_name_handle";
%typemap(rp_add_call) ql_cnv_obj "$1_name_get";
