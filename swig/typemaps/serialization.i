...
%typemap(rp_tm_scr_cnv) QuantLib::Period const & %{
...
%typemap(rp_tm_scr_cnv) QuantLib::Handle<QuantLib::Quote> const & %{
...
%typemap(rp_tm_scr_cnv) QuantLib::Handle<QuantLib::YieldTermStructure> const & %{
    std::string $1_name_str =
        reposit::convert2<std::string>(valueObject->getProperty("$1_name"));
...
%typemap(rp_tm_scr_cnv) QuantLib::Handle<QuantLib::BlackVolTermStructure> const & %{
    std::string $1_name_str =
        reposit::convert2<std::string>(valueObject->getProperty("$1_name"));
    valueObject->processPrecedentID($1_name_str);
    RP_GET_OBJECT_DEFAULT($1_name_coerce, $1_name_str, reposit::Object)
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Natural> const & %{
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Real> const & %{
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Rate> const & %{
   std::vector<double> $1_name_vec =
        reposit::vector::convert2<double>(valueObject->getProperty("$1_name"), "$1_name");
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Spread> const & %{
   std::vector<double> $1_name_vec =
        reposit::vector::convert2<double>(valueObject->getProperty("$1_name"), "$1_name");
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Date> const & %{
...
%typemap(rp_tm_scr_cnv) std::vector<boost::shared_ptr<QuantLib::RateHelper> > const & %{
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Handle<QuantLib::Quote> > const & %{
    std::vector<reposit::property_t> $1_name_vec =
        reposit::vector::convert2<reposit::property_t>(valueObject->getProperty("$1_name"), "$1_name");
...
%typemap(rp_tm_scr_cnv) std::vector<QuantLib::Leg> const & %{
...
%typemap(rp_tm_scr_cnv) std::vector<boost::shared_ptr<QuantLibAddin::Leg> > const & %{
